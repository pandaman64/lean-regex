NOTE: the test cases were taken from https://github.com/rust-lang/regex/tree/master/testdata. The license for the test cases is the same as the license of the `regex` crate.

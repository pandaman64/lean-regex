...
theorem captureNext_soundness {e nfa wf bufferSize it matched}
  ...
  have ⟨it', it'', groups, eqs, le, c, eqv⟩ := captures_of_captureNext_some eq h' v isSome'
  ...
  exact ⟨it', it'', groups, eqs, le, c, refMatched ▸ eqv'⟩
